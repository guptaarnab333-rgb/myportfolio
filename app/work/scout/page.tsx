...
const keyScreens = [
  ["01 · DASHBOARD", "Upload + paste", "Two-input entry surface with the Start Analysis button bridging both panels.", "https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs08/screen-01-dashboard.png?tr=orig-true&v=2"],
  ["02 · REVIEW", "Verify extracted data", "A 17-section accordion where the user corrects whatever the AI mis-parsed.", "https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs08/screen-02-review.png?tr=orig-true&v=2"],
  ["03 · LOADING", "Nine agents working", "The team becomes visible — each card pulses with a live micro-status.", "https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs08/screen-03-loading.png?tr=orig-true&v=2"],
  ["04 · RESULTS", "The verdict", "Score, top strengths, top gaps, agent breakdown, and a draft outreach message.", "https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs08/screen-04-results.png?tr=orig-true&v=2"],
  ["05 · AGENT MODAL", "Drill into one lens", "Positive signals, gaps, risk flags, evidence coverage, agent’s note.", "https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs08/screen-05-modal.png?tr=orig-true&v=2"],
  ["06 · HISTORY", "A track record", "Past analyses with stat cards and a sortable table.", "https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs08/screen-06-history.png?tr=orig-true&v=2"],
];
    ...
    <main className="min-h-screen overflow-x-clip bg-mistblue text-graphite">
      ...
      <div className="mx-auto max-w-[1120px] px-6">
        ...
        <FullBleed className="mt-16">
          <Reveal y={36}>
            <img
              src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs08/thumbnail.png?tr=orig-true"
