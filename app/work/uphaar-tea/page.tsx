    ...
    <main className="min-h-screen overflow-x-clip bg-mistblue text-graphite">
      ...
      <div className="mx-auto max-w-[1120px] px-6">
        ...
        <FullBleed className="mt-28">
          <Reveal y={32}>
            <img loading="lazy" decoding="async" src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs05/context.png?tr=orig-true" alt="" className="h-auto w-full" />
          </Reveal>
        </FullBleed>
        ...
        <Reveal className="mt-28" y={32}>
          <img loading="lazy" decoding="async" src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs05/research.png?tr=orig-true" alt="" className="mx-auto h-auto w-full max-w-[1212px] rounded-[3px]" />
        </Reveal>
        ...
        <FullBleed className="mt-28">
          <Reveal y={32}>
            <img loading="lazy" decoding="async" src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs05/material-quote.png?tr=orig-true" alt="" className="h-auto w-full" />
          </Reveal>
        </FullBleed>
        ...
        <Reveal className="mt-28" y={32}>
          <img loading="lazy" decoding="async" src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs05/design-strategy.png?tr=orig-true" alt="Design Strategy — colour palette and materials" className="h-auto w-full rounded-[3px]" />
        </Reveal>

        {/* ---------- Form Exploration (full-bleed) ---------- */}
        <FullBleed className="mt-28">
          <Reveal y={32}>
            <img loading="lazy" decoding="async" src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs05/form.png?tr=orig-true" alt="" className="h-auto w-full" />
          </Reveal>
        </FullBleed>
        ...
        <Reveal className="mt-10" y={32}>
          <img loading="lazy" decoding="async" src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs05/anatomy.png?tr=orig-true" alt="" className="h-auto w-full rounded-[3px]" />
        </Reveal>
        ...
        <FullBleed className="mt-10">
          <Reveal y={32}>
            <img loading="lazy" decoding="async" src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs05/product-render.png?tr=orig-true" alt="" className="mx-auto h-auto w-full" />
          </Reveal>
        </FullBleed>
        ...
        <FullBleed className="mt-28">
          <Reveal y={32}>
            <img loading="lazy" decoding="async" src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs05/final-design.png?tr=orig-true" alt="" className="h-auto w-full" />
          </Reveal>
        </FullBleed>
          ...
          {lifecycle.map(([img, t, b]) => (
            <Reveal key={img} y={32}>
              <figure className="flex flex-col gap-4">
                <img loading="lazy" decoding="async" src={`https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs05/${img}.png?tr=orig-true`} alt="" className="aspect-[357/280] w-full rounded-[3px] object-cover" />
                <figcaption>
