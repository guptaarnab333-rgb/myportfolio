    ...
    <main className="min-h-screen overflow-x-clip bg-mistblue text-graphite">
      ...
      <div className="mx-auto max-w-[1120px] px-6">
        ...
        <Reveal className="mt-10" y={32}>
          <img src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs06/sitemap.png?tr=orig-true" alt="Gargi sitemap" className="h-auto w-full rounded-[3px]" />
        </Reveal>
        ...
        />
        <Reveal className="mt-10" y={32}>
          <img src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs06/design-system.png?tr=orig-true" alt="Color palette and grid system" className="h-auto w-full rounded-[3px]" />
        </Reveal>
        <Reveal className="mt-6" y={32}>
          <img src="https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs06/thumb-zone.png?tr=orig-true" alt="Thumb-zone ergonomics and screens" className="h-auto w-full rounded-[3px]" />
        </Reveal>
            ...
            <Reveal key={img} delay={60} y={32}>
              ...
              >
                <figure className="flex justify-center">
                  <img src={`https://ik.imagekit.io/cnjxcztbn/portfolio/cases/cs06/${img}.png?tr=orig-true`} alt={title} className="h-auto w-full max-w-[430px]" />
                </figure>
